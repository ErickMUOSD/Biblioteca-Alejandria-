                        ...
                        ?>
                            <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method='POST'>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name='nombre_editorial' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('nombre_editorial') ? 'is-invalid' : 'is-valid' ?>" id="nombre_editorial" aria-describedby="nombre_editorialHelp" value="<?php echo $_POST['nombre_editorial'] ?? '' ?>">

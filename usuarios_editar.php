                        ...
                        ?>
                            <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method='POST'>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name='nombre' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('nombre') ? 'is-invalid' : 'is-valid' ?>" id="nombre" aria-describedby="nombrelHelp" value="<?php echo $_POST['nombre'] ?? '' ?>">
                                    <div id="nombreHelp" class="invalid-feedback"><?php echo isset($errors) && $errors->first('nombre') ?></div>
                                </div>
                                <div class="mb-3">
                                    <label for="primer_apellido" class="form-label">Primer apellido</label>
                                    <input type="text" name='primer_apellido' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('primer_apellido') ? 'is-invalid' : 'is-valid' ?>" id="primer_apellido" aria-describedby="primer_apellidolHelp" value="<?php echo $_POST['primer_apellido'] ?? '' ?>">
                                    <div id="primer_apellidolHelp" class="invalid-feedback"><?php echo isset($errors) && $errors->first('primer_apellido') ?></div>
                                </div>
                                <div class="mb-3">
                                    <label for="segundo_apellido" class="form-label">Segundo apellido</label>
                                    <input type="text" name='segundo_apellido' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('segundo_apellido') ? 'is-invalid' : 'is-valid' ?>" id="segundo_apellido" aria-describedby="segundo_apellidolHelp" value="<?php echo $_POST['segundo_apellido'] ?? '' ?>">
                                    <div id="segundo_apellidoHelp" class="invalid-feedback"><?php echo isset($errors) && $errors->first('segundo_apellido') ?></div>
                                </div>
                                <div class="mb-3">
                                    <label for="correo" class="form-label">Correo</label>
                                    <input type="email" name='correo' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('correo') ? 'is-invalid' : 'is-valid' ?>" id="correo" aria-describedby="correolHelp" value="<?php echo $_POST['correo'] ?? '' ?>">
                                    <div id="correoHelp" class="invalid-feedback"><?php echo isset($errors) && $errors->first('correo') ?></div>
                                </div>
                                <div class="mb-3">
                                    <label for="contrasena" class="form-label">Contraseña</label>
                                    <input type="password" name='contrasena' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('contrasena') ? 'is-invalid' : 'is-valid' ?>" id="contrasena" aria-describedby="contrasenaHelp" value="<?php echo $_POST['contrasena'] ?? '' ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name='numero_celular' class="form-control form-control-sm<?php echo isset($errors) && $errors->has('numero_celular') ? 'is-invalid' : 'is-valid' ?>" id="numero_celular" aria-describedby="numero_celularHelp" value="<?php echo $_POST['numero_celular'] ?? '' ?>">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        $validation = $validator->make($_POST, [
                            'nombre' => 'required|min:2|max:50', 'primer_apellido' => 'required|min:2|max:50', 'segundo_apellido' => 'required|min:2|max:50', 'correo' => 'required|email', 'contrasena' => 'required|min:2', 'numero_celular' => 'required|min:10|max:15', 'estatus_usuario' => 'required|in:Activo,Inactivo', 'privilegio' => 'required|in:Administrador,Usuario'
                        ]);
